...
public class EsProductServiceImpl implements EsProductService{
    ...
    public int importAll() {
        List<EsProduct> list = esProductDao.getAllEsProductList(null);
        Iterable<EsProduct> esProductIterable = esProductRepository.saveAll(list);
    ...
    public void delete(Long id) {
        esProductRepository.deleteById(String.valueOf(id));
    }
    ...
    public Page<EsProduct> search(String keyword, Long brandId, Long productCategoryId, Integer pageNum, Integer pageSize, Integer sort) {
        ...
        LOGGER.info("DSL:{}", searchQuery.toString());
